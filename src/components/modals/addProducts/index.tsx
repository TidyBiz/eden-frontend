...
function AddProducts({ isOpen, setIsOpen, branches }: AddProductsProps) {
                                ...
                                <div className='flex flex-col gap-4'>
                                    <div className='flex gap-4'>
                                        <div className='flex flex-col gap-2 w-3/4'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400'>Nombre</label>
                                            <input
                                                type='text'
                                                id='name'
                                        ...
                                        <div className='flex flex-col gap-2 w-1/4'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400'>PLU</label>
                                            <input
                                                type='text'
                                                id='name'
                                                className='w-full p-2 rounded-md border border-gray-300 dark:border-gray-700'
                                    ...
                                    <div className='flex gap-4'>
                                        <div className='flex flex-col gap-2 w-/3'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400'>Precio</label>
                                            <input
                                                type='text'
                                                id='name'
                                                className='w-full p-2 rounded-md border border-gray-300 dark:border-gray-700'
                                        ...
                                        <div className='flex flex-col gap-2 w-1/3'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400'>Precio Alternativo</label>
                                            <input
                                                type='text'
                                                id='name'
                                                className='w-full p-2 rounded-md border border-gray-300 dark:border-gray-700'
                                        ...
                                        <div className='flex flex-col gap-2 w-1/3'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400 pr-2'>Pesable</label>
                                            <select
                                                id='name'
                                                className='w-full p-2 rounded-md border border-gray-300 dark:border-gray-700'
                                                name='isSoldByWeight'
                                    ...
                                    <div className='flex gap-4'>
                                        <div className='flex flex-col gap-2 w-1/2'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400'>Stock</label>
                                            <input
                                                type='text'
                                                id='name'
                                                className='w-full p-2 rounded-md border border-gray-300 dark:border-gray-700'
                                        ...
                                        <div className='flex flex-col gap-2 w-1/2'>
                                            <label htmlFor='name' className='text-gray-600 dark:text-gray-400 pr-2'>Sucursal</label>
                                            <select
                                                id='name'
                                                className='w-full p-2 rounded-md border border-gray-300 dark:border-gray-700'
                                                name='branchId'
